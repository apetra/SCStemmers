...
public class AnticStemmer extends SCStemmer {
...
//        metrics.processNewStem(word, stemmed);
    ...
    protected void initRules() {
        ...
        wordStart.add("bi");
        wordEnd.add("ti|o|la|lo|li|le|la|h|smo|ste|še|ću|ćeš|će|ćemo|ćete|vši");
        ...
        wordStart.add("bolj");
        wordEnd.add("i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om");
        addPostTransformation("bolj", "i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om", new ReplaceTransformation("dobar"));
        wordStart.add("gor");
        wordEnd.add("i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om");
        addPostTransformation("gor", "i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om", new ReplaceTransformation("zao"));
        wordStart.add("već");
        wordEnd.add("i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om");
        addPostTransformation("već", "i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om", new ReplaceTransformation("velik"));
        wordStart.add("manj");
        wordEnd.add("i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om");
        addPostTransformation("manj", "i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om", new ReplaceTransformation("mali"));
...
//        transformations.put("baci", "baci"); //Antic: nema transformacije
