 ...
 * <br>
 */
public class AnticStemmer3 extends SCStemmer {
...
//        metrics.processNewStem(word, stemmed);
    ...
    public String stemPrefix(String word) {
...
//    }
    ...
    protected void initRules() {
        ...
        // added: MAS2
        // komparativ jotovanje
        // pravila u JotationTRansformation ne idu redom, pa blj moze da se razresi kao lj
        wordStart.add(".+(b|p|m|v)");
        wordEnd.add("(lj)(i|eg|ega|em|emu|im|ima|ih|a|e|oj|u|om)");
        ...
        wordStart.add(".{3,}n");
        wordEnd.add("ik|ika|ike|iku|ikom|ici|icima");
        //removed because 'amater' looses its gain : MAS2
//        wordStart.add(".{3,}");
//        wordEnd.add("(s|š|č)k(ijima|ijega|ijemu|ijem|ijim|ijih|ijoj|ijeg|iji|ije|ija|oga|ome|omu|ima|og|om|im|ih|oj|i|e|o|a|u)");
        // added -čki: MAS1
        ...
        //added en to match 'savrsenstvo' but not 'prijateljstvo' : MAS2
        wordStart.add(".{3,}en");
        wordEnd.add("(s|š)tv(ima|om|o|a|u)");
...
//      tried but removed because degrades accuracy : MAS2
//        wordStart.add(".{3,}");
//        wordEnd.add("nijega|nijemu|nijima|nijeg|nijem|nijim|nijih|nima|niji|nije|nija|niju|noj|nom|nog|nim|nih|an|na|nu|ni|ne|no");
        ...
        //changed so it doesn't match pišeš, vrediš i sl. : MAS2
        //removed empty suffix
        wordStart.add(".+(e|i)š");
        ...
        // need more work - rules for verbs : MAS2
//        wordStart.add(".{3,}");
//        wordEnd.add("ova(smo|ste|hu|ti|še|li|la|le|lo|t|h|o)");
        wordStart.add(".+ova");
...
//        added  (vredis)  : MAS2
        wordStart.add(".+d");
        wordEnd.add("(i|e)(m|š|te|mo|h|ste|smo|še|hu|lo|la|o|l|vši|ći|će|ćeš|ćemo|ćete|)");
       ...
       // need more work - rules for verbs : MAS2
        //added post transformation
//        wordStart.add(".{3,}");
//        wordEnd.add("uj(ući|emo|ete|mo|em|eš|e|u|)");
//        wordStart.add(".+uj");
//        wordEnd.add("ući|emo|ete|mo|em|eš|e|u|");
        wordStart.add(".+jeti");
        ...
        //added from Milosevic stemmer: MAS2
        wordStart.add(".{3,}");
        wordEnd.add("ac|tit|nuš|ut|it|uš|uh|oh|eh|eg|ad|eć|ul|lj|š|j");
        ...
        transformations.put("nici", "nik");
        transformations.put("ticima", "tik");
        transformations.put("tici", "tik");
        transformations.put("zicima", "zik");
        transformations.put("zici", "zik");
